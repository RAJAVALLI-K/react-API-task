                ...
                {data?.map((d, index) => {
                    return (
                        <div key={index} className="rocket-box">
                            <p>FLIGHT NUMBER : {d.flight_number}</p>
                            <Card sx={{ maxWidth: 345 }}>
                                <CardMedia
                                    sx={{ height: 10 }}
                                    image={d.links.mission_patch}
                                    title="green iguana"
                                />
                                <img src={d.links.mission_patch} style={{ width: "100%" }} alt={"img"} />
...
//                   title="green iguana"
//                 />
//                 <img src={d.links.flickr_images[0]} style={{ width: "100%" }} alt={"img"} />
